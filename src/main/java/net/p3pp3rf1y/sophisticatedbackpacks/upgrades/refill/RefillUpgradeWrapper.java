...
public class RefillUpgradeWrapper extends UpgradeWrapperBase<RefillUpgradeWrapper, RefillUpgradeItem>
	...
	private void tryRefillFilter(@Nonnull Entity entity, IInventoryHandlerHelper playerInvHandler, ItemStack filter, TargetSlot targetSlot) {
		...
		IItemHandlerSimpleInserter extractFromHandler = storageWrapper.getInventoryForUpgradeProcessing();
	...
	public enum TargetSlot implements StringRepresentable {
		...
		public static final StreamCodec<FriendlyByteBuf, TargetSlot> STREAM_CODEC = StreamCodecHelper.enumCodec(TargetSlot.class);
